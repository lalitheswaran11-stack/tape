# API surface: @lalitheswaran11-stack/tape-react
...
```ts
import { RecordStore, PolicySpec, TapeClient, Fields, TapeRecord, ConnectionState, MetricsSnapshot, FieldValue, SequenceEntry } from '@lalitheswaran11-stack/tape-core';
